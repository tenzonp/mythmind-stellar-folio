...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "MythMind is a research-led AI company building cognitive systems that reason, remember and create. Discover our vision, team, investors and journal." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@mythmind" },
      { name: "twitter:title", content: "MythMind — Cognitive AI in Service of Human Story" },
      { name: "twitter:description", content: "MythMind is a research-led AI company building cognitive systems that reason, remember and create. Discover our vision, team, investors and journal." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/75fc3c01-9e47-4f59-9e4f-9314996c5dd6/id-preview-2f0f681a--c9c4e03b-eef5-40d5-90e2-15ad31244b29.lovable.app-1780902386288.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/75fc3c01-9e47-4f59-9e4f-9314996c5dd6/id-preview-2f0f681a--c9c4e03b-eef5-40d5-90e2-15ad31244b29.lovable.app-1780902386288.png" },
    ],
    links: [
